                        ...
                        <div class="form-group row justify-content-center">
                            <div class="channel-avatar" onclick="document.getElementById('image').click()">
                                ...
                                <div class="channel-avatar-overlay">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" ria-hidden="true" focusable="false" width="80px" height="80px" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20">
            ...
            <div class="card">
                ...
                {{-- <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <div class="col-md-8">
                            <h4><a href="{{ route('videos.show', ['video'=> $video]) }}">{{ $video->title }}</a></h4>
